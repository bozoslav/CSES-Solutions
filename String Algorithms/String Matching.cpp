...
{ // u vector<int> z sprema koliko slova sa pocetka je nasao od od te pozicije nadalje, ako se trazi pattern u velikom stringu onda se stavi pattern + '◇' + string
    int n = (int)s.length();
    vector<int> z(n);
